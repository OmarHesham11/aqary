    ...
    <>
      ...
      <div className="container">
          ...
          <Carousel>
            { property.photo.map((src, id) =>
              <Carousel.Item key={ id }>
                <img className="d-block w-100" src={ src } alt="First slide" style={ { objectFit: 'cover', maxHeight: '100%', width: '100%' } } />
              </Carousel.Item>
            )
            }
          </Carousel>
        ...
        <header className="mb-4">
          ...
          <div className="container">
            <div className="">
              <p className="text-muted p-description" style={ { textAlign: property.description && isArabicText(property.description) ? "right" : "left", } }> { property.description } </p>
            </div>
          </div>
